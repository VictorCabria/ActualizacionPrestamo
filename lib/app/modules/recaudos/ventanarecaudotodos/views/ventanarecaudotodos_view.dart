...
class VentanarecaudotodosView extends GetView<VentanarecaudotodosController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: GetX<VentanarecaudotodosController>(
...
class CustomCard3 extends StatelessWidget {
  ...
  final VentanarecaudotodosController controller;

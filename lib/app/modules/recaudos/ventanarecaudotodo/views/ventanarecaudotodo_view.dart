...
class VentanarecaudotodoView extends GetView<VentanarecaudotodoController> {
  const VentanarecaudotodoView({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: GetX<VentanarecaudotodoController>(
...
class CustomCard3 extends StatelessWidget {
  ...
  final VentanarecaudotodoController controller;

...
class ListasnegraView extends GetView<ListasnegraController> {
  const ListasnegraView({Key? key}) : super(key: key);
@override
                              ...
                              Container(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      const Text("Préstamo"),
                                      Text(
                                          controller.numberFormat.format(e.totalPrestamo)),
                              ...
                              Container(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      const Text("Saldo"),
                                      Text(
                                          controller.numberFormat.format(e.saldoPrestamo)),
                                    ]),
                              ),
                            ]),
                        /* trailing: IconButton(

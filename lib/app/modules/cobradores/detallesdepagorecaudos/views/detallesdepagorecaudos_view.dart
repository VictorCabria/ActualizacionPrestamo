...
class DetallesdepagorecaudosView
    extends GetView<DetallesdepagorecaudosController> {
  const DetallesdepagorecaudosView({Key? key}) : super(key: key);
@override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: GetX<DetallesdepagorecaudosController>(
...
class CustomCard3 extends StatelessWidget {
  ...
  final DetallesdepagorecaudosController controller;

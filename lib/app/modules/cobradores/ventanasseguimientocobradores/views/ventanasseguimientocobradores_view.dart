...
class VentanasseguimientocobradoresView
    extends GetView<VentanasseguimientocobradoresController> {
  @override
...
class Page1 extends StatelessWidget {
  ...
  final VentanasseguimientocobradoresController controller;

  @override
  Widget build(BuildContext context) {
    return GetX<VentanasseguimientocobradoresController>(
